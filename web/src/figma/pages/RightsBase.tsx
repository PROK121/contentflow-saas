              ...
              <TableShell>
                ...
                <tbody>
                  {([
                    ...
                    ["Вознаграждение KZT", "Сумма, которую компания платит правообладателю", "Это себестоимость прав. Нужна для расчёта маржинальности при продаже"],
              ...
              <TableShell>
                ...
                <tbody>
                  {([
                    ...
                    ["Вознаграждение KZT", "Сумма лицензионного платежа от покупателя", "Выручка по сделке. Сравните с себестоимостью из закупа для расчёта маржи"],
