...
let PortalController = class PortalController {
    ...
    summary(orgId) {
        if (!orgId) {
            throw new common_1.BadRequestException('Query orgId (rights holder organization id) is required');
        }
...
], PortalController.prototype, "summary", null);
exports.PortalController = PortalController = __decorate([
    (0, common_1.Controller)('portal/rights-owner'),
